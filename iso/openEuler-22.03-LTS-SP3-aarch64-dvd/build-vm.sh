...
ISOURL="https://mirrors.pku.edu.cn/openeuler/openEuler-22.03-LTS-SP3/ISO/aarch64/openEuler-22.03-LTS-SP3-aarch64-dvd.iso"
WORKDIR=$(pwd)
...
qemu-system-aarch64 \
	...
	-append "inst.ks=http://192.168.122.1:${FILE_SERVER_PORT}/ks.cfg inst.stage2=hd:LABEL=openEuler-22.03-LTS-SP3-aarch64 inst.text inst.cmdline earlyprintk ignore_loglevel console=ttyAMA0,115200n8 earlycon=pl011,mmio,0x09000000 level=10 net.ifnames=0 biosdevname=0 " \
	-serial mon:stdio \
	-net nic \
