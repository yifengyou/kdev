...
ISOURL="https://mirrors.bfsu.edu.cn/fedora/releases/42/Server/x86_64/iso/Fedora-Server-dvd-x86_64-42-1.1.iso"
WORKDIR=$(pwd)
...
qemu-system-x86_64 \
	...
	-append "inst.ks=http://192.168.122.1:${FILE_SERVER_PORT}/ks.cfg inst.stage2=hd:LABEL=${LABEL} inst.text inst.cmdline earlyprintk ignore_loglevel console=ttyS0 level=10 net.ifnames=0 biosdevname=0 " \
	-serial mon:stdio \
	-net nic \
