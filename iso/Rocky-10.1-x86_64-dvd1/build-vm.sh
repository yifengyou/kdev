...
ISOURL="https://dl.rockylinux.org/vault/rocky/10.1/isos/x86_64/Rocky-10.1-x86_64-dvd1.iso"
WORKDIR=$(pwd)
...
qemu-system-x86_64 \
	...
	-append "inst.ks=http://192.168.122.1:${FILE_SERVER_PORT}/ks.cfg inst.stage2=hd:LABEL=Rocky-10-1-x86_64-dvd inst.text inst.cmdline earlyprintk ignore_loglevel console=tty0 level=10 net.ifnames=0 biosdevname=0 " \
	-serial mon:stdio \
	-net nic \
