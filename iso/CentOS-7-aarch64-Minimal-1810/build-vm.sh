...
ISOURL="https://archive.kernel.org/centos-vault/altarch/7.6.1810/isos/aarch64/CentOS-7-aarch64-Minimal-1810.iso"
WORKDIR=$(pwd)
...
qemu-system-aarch64 \
	...
	-append "inst.ks=http://192.168.122.1:${FILE_SERVER_PORT}/ks.cfg inst.stage2=hd:/dev/vdb inst.text inst.cmdline earlyprintk ignore_loglevel console=ttyAMA0,115200n8 earlycon=pl011,mmio,0x09000000 level=10 net.ifnames=0 biosdevname=0 selinux=0 " \
	-serial mon:stdio \
	-net nic \
