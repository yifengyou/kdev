...
ISOURL="https://mirror.nju.edu.cn/rocky-vault/10.0/isos/x86_64/Rocky-10.0-x86_64-minimal.iso"
WORKDIR=$(pwd)
...
qemu-system-x86_64 \
	...
	-append "inst.ks=http://192.168.122.1:${FILE_SERVER_PORT}/ks.cfg inst.stage2=hd:LABEL=Rocky-10-0-x86_64-dvd inst.text inst.cmdline earlyprintk ignore_loglevel console=ttyS0 level=10 net.ifnames=0 biosdevname=0 " \
	-serial mon:stdio \
	-net nic \
