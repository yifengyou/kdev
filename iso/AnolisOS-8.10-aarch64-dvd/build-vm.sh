...
ISOURL="https://mirrors.openanolis.cn/anolis/8/isos/GA/aarch64/AnolisOS-8.10-aarch64-dvd.iso"
WORKDIR=$(pwd)
...
if [ ! -f mnt/images/pxeboot/vmlinuz-5.10.134-18.an8.aarch64 ]; then
	echo "mnt/images/pxeboot/vmlinuz-5.10.134-18.an8.aarch64 does't exists!"
	exit 1
fi

if [ ! -f mnt/images/pxeboot/initrd-5.10.134-18.an8.aarch64.img ]; then
...
qemu-system-aarch64 \
	...
	-cdrom ${ISONAME} \
	-boot order=dc \
	-kernel mnt/images/pxeboot/vmlinuz-5.10.134-18.an8.aarch64 \
	-initrd mnt/images/pxeboot/initrd-5.10.134-18.an8.aarch64.img \
