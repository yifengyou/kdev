...
ISOURL="https://dl.rockylinux.org/vault/rocky/8.6/isos/aarch64/Rocky-8.6-aarch64-minimal.iso"
WORKDIR=$(pwd)
...
qemu-system-aarch64 \
	...
	-append "inst.ks=http://192.168.122.1:${FILE_SERVER_PORT}/ks.cfg inst.stage2=hd:LABEL=Rocky-8-6-aarch64-dvd inst.text inst.cmdline earlyprintk ignore_loglevel console=ttyAMA0,115200n8 earlycon=pl011,mmio,0x09000000 level=10 net.ifnames=0 biosdevname=0 " \
	-serial mon:stdio \
	-net nic \
