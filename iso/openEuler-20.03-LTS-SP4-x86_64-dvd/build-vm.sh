...
ISOURL="https://mirrors.pku.edu.cn/openeuler/openEuler-20.03-LTS-SP4/ISO/x86_64/openEuler-20.03-LTS-SP4-x86_64-dvd.iso"
WORKDIR=$(pwd)
...
qemu-system-x86_64 \
	...
	-append "inst.ks=http://192.168.122.1:${FILE_SERVER_PORT}/ks.cfg inst.stage2=hd:LABEL=openEuler-20.03-LTS-SP4-x86_64 inst.text inst.cmdline earlyprintk ignore_loglevel console=ttyS0 level=10 net.ifnames=0 biosdevname=0 " \
	-serial mon:stdio \
	-net nic \
