...
export QCOW2_URL="https://dl.rockylinux.org/pub/rocky/${set_version}/images/aarch64/${QCOW2}"
export build_tag="${set_vendor}_${set_version}"
...
eval $(fdisk -l qcow2.raw | grep "^qcow2.raw" | tail -1 | awk '{print "start="$3"; sectors="$4}')
