...
virsh destroy kdev-rockylinux9 || :
virsh undefine kdev-rockylinux9 --nvram || :
...
if [ ! -f Rocky-9.3-x86_64-minimal.iso ]; then
	wget -c https://mirrors.ustc.edu.cn/rocky/9.3/isos/x86_64/Rocky-9.3-x86_64-minimal.iso
fi

virt-install --connect qemu:///system \
	--name kdev-rockylinux9 \
	...
	--location Rocky-9.3-x86_64-minimal.iso \
