...
ISOURL="https://old-releases.ubuntu.com/releases/22.04/ubuntu-22.04-live-server-amd64.iso"
ISOURL="https://mirrors.aliyun.com/ubuntu-releases/jammy/ubuntu-22.04.5-live-server-amd64.iso"
FILE_SERVER_PORT="63335"
VMNAME="kdev-ubuntu22"
...
virt-install \
	...
	--extra-args=" ds=nocloud-net;s=http://192.168.122.1:${FILE_SERVER_PORT} cloud-config-url=/dev/null autoinstall priority=critical earlyprintk console=ttyS0,115200n8 " \
	--graphics none \
